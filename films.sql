...
\restrict 0lWpraRlocmPgcGEMnj8EcYZhPKJqqrym474PQyqCqDwEDvqKbgjuycHszkcB1X
...
\unrestrict 0lWpraRlocmPgcGEMnj8EcYZhPKJqqrym474PQyqCqDwEDvqKbgjuycHszkcB1X
\connect film
\restrict 0lWpraRlocmPgcGEMnj8EcYZhPKJqqrym474PQyqCqDwEDvqKbgjuycHszkcB1X
...
COPY public.comment (id, users_id, film_id, comment, created_at, updated_at) FROM stdin;
1	1	1	Отличный фильм! Первый комментарий через API.	2025-12-25 23:46:08.119139	2025-12-25 23:46:08.119139
\.
...
1	user1	$1$iz58Wb/H$.4AsbkYRjiQrQS84F1uH51	2025-12-24	user
2	user2	$1$8gWe6C0T$CsX.YZRYAeHnaUyZoq6zx1	2025-12-24	user
3	user3	$1$VvKNtmxo$TO/Q0jHG1jsvcWAJbFYeP/	2025-12-24	user
4	user4	$1$sBx8BI90$VeWovAzvqHICUzMWQA.251	2025-12-24	user
5	user5	$1$SaiScSMb$sDPqsxJAOGbnhkBEae36R.	2025-12-24	user
6	user6	$1$10E1x.cf$tisPeGqD559UmZVz/wGL01	2025-12-24	user
7	user7	$1$wNLe9PPX$X3mBQvhOgG9JjvhexWLF9/	2025-12-24	user
8	user8	$1$Ik257jho$qReOpSvlf/goVnHmkMgwO1	2025-12-24	user
9	user9	$1$pRp5A0XN$ObyHlOSLcgUgSGkHDZDhp0	2025-12-24	user
10	user10	$1$/qfmJsbu$Wb/ATfVTwhH5blbSZ5sel0	2025-12-24	user
11	user11	$1$CspgaNxi$dLqc5kI8F.LHgOOSS8Dl20	2025-12-24	user
12	user12	$1$GXN7iEPv$.X.jtF.YTGugjiyE1svA60	2025-12-24	user
13	user13	$1$ErCfcpKN$QEIDwm73n4oWo2vG4cTBF0	2025-12-24	user
14	user14	$1$E.dJepZA$aNRznf9K1OnO0CNPut86v.	2025-12-24	user
15	user15	$1$Nq.5L9fG$1U/enAXbREmx9bij57V55/	2025-12-24	user
16	user16	$1$slt.lkte$v8deBwkPe9tsKvOdmFto..	2025-12-24	user
17	user17	$1$9bnOw6Xz$IVJ3KyzUmgBux6Msdt7Rs.	2025-12-24	user
18	user18	$1$FVaBnK4c$59drOStoJrC99kkaXSvyv/	2025-12-24	user
19	user19	$1$UbJb7yiz$77iXJjOKsuja6hXPz6mCB.	2025-12-24	user
20	admin_user	$1$eDm52nFv$Kv/SLq51thB1SfH3BkO4A.	2025-12-24	admin
\.
...
--
-- Name: comment update_comment_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
